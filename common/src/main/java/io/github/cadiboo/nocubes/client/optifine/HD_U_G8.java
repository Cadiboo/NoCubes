...
class HD_U_G8 extends HD_U_G7 {
	...
	interface Reflect {
		...
		Field useMidBlockAttrib = Reflector.tryGetField("net.optifine.shaders.Shaders", "useMidBlockAttrib");
		MethodHandle setMidBlock = Reflector.tryGetMethod(BufferBuilder.class.getName(), "setMidBlock", float.class, float.class, float.class);
