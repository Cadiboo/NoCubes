...
public class SoftBlockRenderer {
   public boolean renderSoftBlock(Block block, int x, int y, int z, RenderBlocks renderer, IBlockAccess world) {
      ...
      Vec3[] points = new Vec3[]{Vec3.func_72443_a(0.0D, 0.0D, 0.0D), Vec3.func_72443_a(1.0D, 0.0D, 0.0D), Vec3.func_72443_a(1.0D, 0.0D, 1.0D), Vec3.func_72443_a(0.0D, 0.0D, 1.0D), Vec3.func_72443_a(0.0D, 1.0D, 0.0D), Vec3.func_72443_a(1.0D, 1.0D, 0.0D), Vec3.func_72443_a(1.0D, 1.0D, 1.0D), Vec3.func_72443_a(0.0D, 1.0D, 1.0D)};

      int side;
      for(side = 0; side < 8; ++side) {
         Vec3 vec3 = points[side];
         vec3.field_72450_a += (double)x;
         Vec3 vec4 = points[side];
         vec4.field_72448_b += (double)y;
         Vec3 vec5 = points[side];
         vec5.field_72449_c += (double)z;
      ...
      for(side = 0; side < 6; ++side) {
         ...
         if (renderer.field_147837_f || block.func_149646_a(world, facingX, facingY, facingZ, side)) {
            ...
            tessellator.func_78386_a(1.0F * colorFactor * colorRed, 1.0F * colorFactor * colorGreen, 1.0F * colorFactor * colorBlue);
            tessellator.func_78374_a(vertex0.field_72450_a, vertex0.field_72448_b, vertex0.field_72449_c, minU, maxV);
            tessellator.func_78374_a(vertex2.field_72450_a, vertex2.field_72448_b, vertex2.field_72449_c, maxU, maxV);
            tessellator.func_78374_a(vertex3.field_72450_a, vertex3.field_72448_b, vertex3.field_72449_c, maxU, minV);
            tessellator.func_78374_a(vertex4.field_72450_a, vertex4.field_72448_b, vertex4.field_72449_c, minU, minV);
         }
      }
   ...
   public static boolean doesPointIntersectWithManufactured(IBlockAccess world, Vec3 point) {
      for(int i = 0; i < 4; ++i) {
         ...
         Block block2 = world.func_147439_a(x1, (int)point.field_72448_b - 1, z1);
   ...
   public boolean doesPointIntersectWithLiquid(int x, int y, int z, IBlockAccess world) {
      return NoCubes.isBlockLiquid(world.func_147439_a(x, y, z)) || NoCubes.isBlockLiquid(world.func_147439_a(x - 1, y, z)) || NoCubes.isBlockLiquid(world.func_147439_a(x, y, z - 1)) || NoCubes.isBlockLiquid(world.func_147439_a(x - 1, y, z - 1)) || NoCubes.isBlockLiquid(world.func_147439_a(x, y + 1, z)) || NoCubes.isBlockLiquid(world.func_147439_a(x - 1, y + 1, z)) || NoCubes.isBlockLiquid(world.func_147439_a(x, y + 1, z - 1)) || NoCubes.isBlockLiquid(world.func_147439_a(x - 1, y + 1, z - 1));
   }
   ...
   public boolean renderGhostLiquid(Block block, int x, int y, int z, int brightness, RenderBlocks renderer, IBlockAccess world) {
      ...
      if (this.doesPointIntersectWithLiquid(x, y, z + 1, world)) {
         height2 = (double)renderer.func_147729_a(x, y, z + 1, material);
      }

      if (this.doesPointIntersectWithLiquid(x + 1, y, z + 1, world)) {
         height3 = (double)renderer.func_147729_a(x + 1, y, z + 1, material);
      }

      if (this.doesPointIntersectWithLiquid(x + 1, y, z, world)) {
         height4 = (double)renderer.func_147729_a(x + 1, y, z, material);
      }

      height0 -= 0.0010000000474974513D;
      height2 -= 0.0010000000474974513D;
      height3 -= 0.0010000000474974513D;
      height4 -= 0.0010000000474974513D;
      ...
      tessellator.func_78374_a((double)(x + 0), (double)y + height2, (double)(z + 1), minU, maxV);
      tessellator.func_78374_a((double)(x + 1), (double)y + height3, (double)(z + 1), maxU, maxV);
      tessellator.func_78374_a((double)(x + 1), (double)y + height4, (double)(z + 0), maxU, minV);
      return true;
   }
   ...
   public static void inject(Block block, World world, int x, int y, int z, AxisAlignedBB aabb, List list, Entity entity) {
      ...
      float f2 = SmoothBlockRenderer2.getSmoothBlockHeightForCollision(world, block, x, y, z + 1);
      float f3 = SmoothBlockRenderer2.getSmoothBlockHeightForCollision(world, block, x + 1, y, z + 1);
      float f4 = SmoothBlockRenderer2.getSmoothBlockHeightForCollision(world, block, x + 1, y, z);
   ...
   public static void addBBoundsToList(int x, int y, int z, float minX, float minY, float minZ, float maxX, float maxY, float maxZ, AxisAlignedBB aabb, List list) {
      AxisAlignedBB aabb2 = AxisAlignedBB.func_72330_a((double)((float)x + minX), (double)((float)y + minY), (double)((float)z + minZ), (double)((float)x + maxX), (double)((float)y + maxY), (double)((float)z + maxZ));
      if (aabb2 != null && aabb.func_72326_a(aabb2)) {
         list.add(aabb2);
      }
