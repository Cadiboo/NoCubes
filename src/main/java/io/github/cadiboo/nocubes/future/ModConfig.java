...
public final class ModConfig {
	...
	public ModConfig(final Type type, final ForgeConfigSpec spec, final FutureModContainer container, final String fileName) {
		this.type = type;
		this.spec = spec;
	...
	public ModConfig(final Type type, final ForgeConfigSpec spec, final FutureModContainer activeContainer) {
	...
	void fireEvent(final ModConfigEvent configEvent) {
		container.dispatchConfigEvent(configEvent);
	}
