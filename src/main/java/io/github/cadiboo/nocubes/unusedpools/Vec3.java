...
//
//	@Deprecated
//	public io.github.cadiboo.nocubes.unusedpools.Vec3 withOffset(final float x, final float y, final float z) {
//		return new io.github.cadiboo.nocubes.unusedpools.Vec3(
//				this.x + x,
//				this.y + y,
//				this.z + z
//		);
//	}
//
//	public io.github.cadiboo.nocubes.unusedpools.Vec3 addOffset(final float x, final float y, final float z) {
//		this.x += x;
//		this.y += y;
//		this.z += z;
//		return this;
