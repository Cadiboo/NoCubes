...
//		final int chunkRenderPosY,
//		final int chunkRenderPosZ,
//		final LightCache packedLightCache,
//		final PooledMutableBlockPos pooledMutableBlockPos
//	) {
...
//					packedLight0[index] = LightCache.get(x0, y0, z0, cache, lazyPackedLightCache.getIndex(x0, y0, z0, sizeX, sizeY), stateCache, reader, pooledMutableBlockPos, chunkRenderPosX, chunkRenderPosY, chunkRenderPosZ, startPaddingX, startPaddingY, startPaddingZ, diffX, diffY, diffZ, stateCacheSizeX, stateCacheSizeY);
//					final int x1 = v1XOffset + xOffset;
//					final int y1 = v1YOffset + yOffset;
//					final int z1 = v1ZOffset + zOffset;
//					packedLight1[index] = LightCache.get(x1, y1, z1, cache, lazyPackedLightCache.getIndex(x1, y1, z1, sizeX, sizeY), stateCache, reader, pooledMutableBlockPos, chunkRenderPosX, chunkRenderPosY, chunkRenderPosZ, startPaddingX, startPaddingY, startPaddingZ, diffX, diffY, diffZ, stateCacheSizeX, stateCacheSizeY);
//					final int x2 = v2XOffset + xOffset;
//					final int y2 = v2YOffset + yOffset;
//					final int z2 = v2ZOffset + zOffset;
//					packedLight2[index] = LightCache.get(x2, y2, z2, cache, lazyPackedLightCache.getIndex(x2, y2, z2, sizeX, sizeY), stateCache, reader, pooledMutableBlockPos, chunkRenderPosX, chunkRenderPosY, chunkRenderPosZ, startPaddingX, startPaddingY, startPaddingZ, diffX, diffY, diffZ, stateCacheSizeX, stateCacheSizeY);
//					final int x3 = v3XOffset + xOffset;
//					final int y3 = v3YOffset + yOffset;
//					final int z3 = v3ZOffset + zOffset;
//					packedLight3[index] = LightCache.get(x3, y3, z3, cache, lazyPackedLightCache.getIndex(x3, y3, z3, sizeX, sizeY), stateCache, reader, pooledMutableBlockPos, chunkRenderPosX, chunkRenderPosY, chunkRenderPosZ, startPaddingX, startPaddingY, startPaddingZ, diffX, diffY, diffZ, stateCacheSizeX, stateCacheSizeY);
//				}
//			}
//		}
//
