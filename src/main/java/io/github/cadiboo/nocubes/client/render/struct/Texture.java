...
public final /* inline record */ class Texture {
	...
	public static Texture forQuadRearranged(Texture valhallaPls, BakedQuad quad, EnumFacing faceDirection) {
	...
	private void rearrangeForDirection(EnumFacing direction) {
		switch (direction) {
			case NORTH:
			case EAST:
				break;
