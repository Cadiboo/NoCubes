...
//			Pair.of(ModConfig.Type.COMMON, Common.SPEC),
	...
	public static class Server {
		...
		static class Impl {
			...
			final BooleanValue extraSmoothMesh;
			...
			private Impl(ForgeConfigSpec.Builder builder) {
				...
				extraSmoothMesh = builder
					.translation(NoCubes.MOD_ID + ".config.extraSmoothMesh")
					.comment("If the mesh generated by SurfaceNets and MarchingCubes should be twice as smooth")
					.define("extraSmoothMesh", false);
			}
