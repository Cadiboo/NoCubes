...
import io.github.cadiboo.nocubes.future.ForgeConfigSpec.*;
...
//		}
	...
	public static class Client {
		...
		static void bake() {
			...
			List<? extends String> whitelist = INSTANCE.terrainSmoothableWhitelistPreference.get();
			List<? extends String> blacklist = INSTANCE.terrainSmoothableBlacklistPreference.get();
		...
		static class Impl {
			...
			private Impl(final ForgeConfigSpec.Builder builder) {
				...
				terrainSmoothableWhitelistPreference = builder
					.translation(NoCubes.MOD_ID + ".config.terrainSmoothableWhitelistPreference")
				...
				terrainSmoothableBlacklistPreference = builder
					.translation(NoCubes.MOD_ID + ".config.terrainSmoothableBlacklistPreference")
						...
						.push("fluids");
				{
					...
					naturalFluidTextures = builder
							...
							.translation(NoCubes.MOD_ID + ".config.naturalFluidTextures")
		...
		static class Impl {
			...
			private Impl(final ForgeConfigSpec.Builder builder) {
				autoUpdaterEnabled = builder
						.translation(NoCubes.MOD_ID + ".config.autoUpdaterEnabled")
