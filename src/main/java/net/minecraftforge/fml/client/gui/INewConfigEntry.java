 ...
 */
public interface INewConfigEntry {

	/**
	 * Gets the IConfigElement object owned by this entry.
	 */
	INewConfigElement getConfigElement();
	...
	/**
	 * Handles user keystrokes for any GuiTextField objects in this entry. Call {@link GuiTextField#keyPressed(int, int, int)} for any GuiTextField
	 * objects that should receive the input provided.
	 */
	void keyPressed(int p_keyPressed_1_, int p_keyPressed_2_, int p_keyPressed_3_);

	/**
	 * Call {@link GuiTextField#tick()} for any GuiTextField objects in this entry.
	 */
	void tick();

	/**
	 * Call {@link GuiTextField#mouseClicked(double, double, int)} for and GuiTextField objects in this entry.
	 */
	void mouseClicked(double x, double y, int mouseEvent);
