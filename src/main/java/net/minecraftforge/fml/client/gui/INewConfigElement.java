 ...
 * @author bspkrs
 */
public interface INewConfigElement
{
    /**
    ...
    /**
     * This method returns a class that implements {@link INewConfigEntry} or null. This class MUST
     * provide a constructor with the following parameter types: {@link GuiConfig}, {@link GuiConfigEntries}, {@link INewConfigElement}
     *
     ...
     */
    Class<? extends INewConfigEntry> getConfigEntryClass();
    
    /**
     * This method returns a class that implements {@link IArrayEntry}. This class MUST provide a constructor with the
     * following parameter types: {@link GuiEditArray}, {@link GuiEditArrayEntries}, {@link INewConfigElement}, {@link Object}
     *
     ...
     */
    List<INewConfigElement> getChildElements();
