...
//        public void accept(ChannelHandlerContext ctx, FMLHandshakeMessage msg, Consumer<? super FMLHandshakeServerState> cons)
//        {
//            // NoCubes - Go to CONFIG instead of COMPLETE
...
//    CONFIG { // 8
//        @Override
//        public void accept(final ChannelHandlerContext ctx, @Nullable final FMLHandshakeMessage msg, final Consumer<? super FMLHandshakeServerState> cons) {
//            cons.accept(COMPLETE);
//            for (final Pair<String, FMLHandshakeMessage.S2CConfigData> pair : ConfigTracker.INSTANCE.syncConfigs(false)) {
//                NoCubes.LOGGER.info("Sending Config: {}", pair.getKey());
//                ctx.writeAndFlush(pair.getValue()).addListener(ChannelFutureListener.FIRE_EXCEPTION_ON_FAILURE);
//            }
//            ctx.writeAndFlush(new FMLHandshakeMessage.HandshakeAck(ordinal())).addListener(ChannelFutureListener.FIRE_EXCEPTION_ON_FAILURE);
//        }
//    }
