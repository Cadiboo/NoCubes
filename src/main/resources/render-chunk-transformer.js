...
var targetClass = "net.minecraft.client.renderer.chunk.RenderChunk";
var targetMethods = [
	new TargetMethod(
		"func_178581_b", // rebuildChunk
		"(FFFLnet/minecraft/client/renderer/chunk/ChunkRenderTask;)V",
...
//   L34
	...
	var getAllInBoxMutable_name = mapMethod("func_177975_b"); // getAllInBoxMutable
...
//    IFEQ L63
	...
	var getRenderType_name = mapMethod("func_185901_i"); // getRenderType
