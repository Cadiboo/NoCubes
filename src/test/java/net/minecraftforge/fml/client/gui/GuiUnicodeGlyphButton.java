...
public class GuiUnicodeGlyphButton extends GuiButtonExt
{
    ...
    public GuiUnicodeGlyphButton(int id, int xPos, int yPos, int width, int height, String displayString, String glyph, float glyphScale, DoubleBiConsumer onClick)
    {
